...
Route::get('/purchase/bill/{id}', [App\Http\Controllers\PurchaseController::class, 'show'])->name('purchase.bill');
Route::get('/purchase/return/{id}', [App\Http\Controllers\PurchaseController::class, 'return'])->name('purchase.return');
...
Route::post('/purchaseitem/return/{id}', [App\Http\Controllers\PurchaseItemController::class, 'update'])->name('purchaseitem.return');
